...
const deletebook = async (id) => {
  try {
    const response = await fetch(`https://kiran1432.pythonanywhere.com/book_delete/${id}`, {
      method: "DELETE",
      headers: {
...
const libbooks = async () => {
  const userdata = await fetch("https://kiran1432.pythonanywhere.com/book_view", {
    method: "GET",
    headers: {
      "Content-type": "application/json",
      "X-CSRFToken": csrfToken,
...
const add_book = async (book_name, book_description, book_author) => {
  ...
  const data = await fetch("https://kiran1432.pythonanywhere.com/book_add", {
    method: "POST",
...
const update_book = async (
  ...
  const data = await fetch("https://kiran1432.pythonanywhere.com/book_update/" + String(id), {
    method: "PUT",
    body: JSON.stringify(addfile),
    headers: {
      "Content-type": "application/json",
...
const libmembers = async () => {
  const userdata = await fetch("https://kiran1432.pythonanywhere.com/member", {
    method: "GET",
    headers: {
      "Content-type": "application/json",
      "X-CSRFToken": csrfToken,
...
const add_member = async (name, password, email) => {
  ...
  const data = await fetch("https://kiran1432.pythonanywhere.com/member", {
    method: "POST",
    body: JSON.stringify(addfile),
    headers: {
      "Content-type": "application/json",
...
const update_member = async (id, name, password, email) => {
  ...
  const data = await fetch("https://kiran1432.pythonanywhere.com/member/" + String(id), {
    method: "PUT",
    body: JSON.stringify(addfile),
    headers: {
      "Content-type": "application/json",
...
const deletemember = (id) => {
  const delete_fetch = async () => {
    try {
      const response = await fetch(`https://kiran1432.pythonanywhere.com/member/${id}`, {
        method: "DELETE",
        headers: {
          "Content-type": "application/json",
          "X-CSRFToken": csrfToken,
